              ...
              child: Column(
                children: [
                  ...
                  DropdownButtonFormField(
                    ...
                    items: [
                      DropdownMenuItem(
                        child: Text("Basic Package (Starts at 1650 Rs/sqft)"),
                        value: 'Basic',
                      ),
                      DropdownMenuItem(
                        child: Text("Classic Package (Starts at 1765 Rs/sqft)"),
                        value: 'Classic',
                      ),
                      DropdownMenuItem(
                        child: Text("Premium Package (Starts at 1865 Rs/sqft)"),
                        value: 'Premium',
                      ),
                      DropdownMenuItem(
                        child: Text("Royal Package (Starts at 1990 Rs/sqft)"),
                        value: 'Royal',
                      ),
                    ],
                    validator: (value) =>
                  ...
                  RaisedButton(
                    ...
                    onPressed: () {
                      ...
                      try {
                        ...
                        _firestore.collection('houseconstruction').add({
                          'name': _name,
