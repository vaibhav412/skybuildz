    ...
    return ModalProgressHUD(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Compound Wall Construction'),
        ),
              ...
              child: Column(
                children: [
                  ...
                  DropdownButtonFormField(
                    ...
                    items: [
                      DropdownMenuItem(
                        child: Text("Basic Package (Starts at 680 Rs/sqft)"),
                        value: 'Basic',
                      ),
                      DropdownMenuItem(
                        child: Text("Classic Package (Starts at 850 Rs/sqft)"),
                        value: 'Classic',
                      ),
                      DropdownMenuItem(
                        child: Text("Premium Package (Starts at 1060 Rs/sqft)"),
                        value: 'Premium',
                      ),
                    ],
                    validator: (value) =>
                  ...
                  RaisedButton(
                    ...
                    onPressed: () {
                      ...
                      try {
                        ...
                        _firestore.collection('wallconstruction').add({
                          'name': _name,
