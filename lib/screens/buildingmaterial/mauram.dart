...
class MauramDetails extends StatefulWidget {
  @override
  _MauramDetailsState createState() => _MauramDetailsState();
}

class _MauramDetailsState extends State<MauramDetails> {
  @override
              ...
              Stack(
                children: [
                  Container(
                    ...
                    child: FittedBox(
                      child: Image.asset('assets/img/mauram.jpg'),
                      fit: BoxFit.fill,
                    ),
                  ),
                  Container(
                                ...
                                Column(
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        'Our industry experience in this domain helped us to offer a broad range of mauram to our reputed customers.',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 16,
                                    ...
                                    Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        'Usage/Application: Used in levelling the house surface area.',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
