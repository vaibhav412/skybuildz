...
class BrickDetails extends StatefulWidget {
  @override
  _BrickDetailsState createState() => _BrickDetailsState();
}
              ...
              Stack(
                children: [
                  Container(
                    ...
                    child: FittedBox(
                      child: Image.asset('assets/img/brick1.jpg'),
                      fit: BoxFit.fill,
                    ),
                  ),
                  Container(
                                ...
                                Column(
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        'We provide an extensive range of red bricks procured from some of the certified vendors of the industry. The provided products are formulated by the use of finest quality materials and sophisticated techniques.',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 16,
                                    ...
                                    Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        'Usage/Application: Construction of Side Walls, Partition Walls.',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
                                    ...
                                    Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        'Brands : Gulati, NBF, KBF, DBMC, etc.',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
                                    ...
                                    Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        'Sizes : 9 inch X 4 inch X 3 Inch',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
                                    ...
                                    Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        'Resistance Durability: Water Resistant, Seewage Resistant',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
