              ...
              Stack(
                children: [
                  Container(
                    ...
                    child: FittedBox(
                      child: Image.asset('assets/img/sand.jpg'),
                      fit: BoxFit.fill,
                    ),
                  ),
                  Container(
                                ...
                                Column(
                                  children: [
                                    ...
                                    Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        'Usage/Application: Construction of house, commercial buildings, etc.',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
                                    ...
                                    Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        'Varieties Available: Arach, Ramnagar Available',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
                                    ...
                                    Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        'Packaging Type : Truck & Tractor loads',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
                                    ...
                                    Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        'These sands doesn\'t contain any unwanted material in it like plastic, rubber, blacksand, etc',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat',
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
